        ...
        <div class="profile-wrapper-area py-3">
          ...
          <div class="card user-info-card">
            <div class="card-body p-4 d-flex align-items-center">
              <div class="user-profile mr-3"><img src="./img/web.png" alt=""></div>
              <div class="user-info">
          ...
          <div class="card user-data-card">
            <div class="card-body">
              <div class="single-profile-data d-flex align-items-center justify-content-between">
                ...
                <div class="data-content"><?php echo $euid?>@taskscheduler.com</div>
              </div>
              <div class="single-profile-data d-flex align-items-center justify-content-between">
			  ...
			  <div class="single-profile-data d-flex align-items-center justify-content-between">
                <div class="title d-flex align-items-center"><i class="lni lni-user"></i><span>Mobile Number</span></div>
