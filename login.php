      ...
      <div class="container">
        <div class="row justify-content-center">
		  ...
		  <div class="alert <?php echo $alert; ?>" role="alert" style="<?php echo $show; ?>"><?php echo $error; ?></div>
            ...
            <div class="register-form mt-5 px-4">
              <form action="" method="POST">
                <div class="form-group text-left mb-4"><span>Email Id</span>
                  ...
                  <input class="form-control" name="email" id="email" type="email" autocomplete="off" placeholder="Email Id">
                </div>
			...
			<!--<a class="forgot-password d-block mt-3 mb-1" href="forget-password.php">Forgot Password?</a>-->
              <br/><p class="mb-0">Don't have an account?<a class="ml-1" href="register.php">Register Now</a></p>
            </div>
            <!-- View As Guest-->
          </div>
        </div>
