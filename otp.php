	...
	{ 
		...
		if($result->num_rows>0){
			...
			if ($result->num_rows > 0){
				...
				$sql = "INSERT INTO end_user ( euname, eumob, eupass, email, bdate, gender, address, euregdate, status)
				VALUES ('$euname', '$myusername','$mypassword','$email', '$bdate', '$gender', '$address', '$today', 0)";
            ...
            <div class="otp-form mt-5 mx-4">
              <form action="./otp-confirm.php" method="POST">
                <div class="mb-4 d-flex">
                  ...
                  <input class="form-control pl-0" name="email" id="email" type="text" value="<?php echo $email;?>" placeholder="Enter phone number" required readonly>
                  <input class="form-control pl-0" name="mobile" id="phone_number" type="hidden" value="<?php echo $myusername;?>" placeholder="Enter phone number" required readonly>
                </div>
