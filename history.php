...
<head>
    ...
    <!-- Title-->
    <title>History | Task Scheduler System</title>
    <!-- Favicon-->
        ...
        <div class="container-fluid">
          ...
          <div class="row g-3">
			...
			<?php
				  ...
				  $sql = "SELECT * FROM task t, end_user eu WHERE  eu.euid=t.euid AND t.euid=$user_id AND t.task_status=2 ORDER BY t.task_id DESC";
				  $result = $conn->query($sql);
				  if ($result->num_rows > 0) {
					  $count=0;
